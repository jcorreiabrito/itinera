  ...
  kit: {
    ...
    csp: {
      ...
      directives: {
        ...
        'img-src': ['self', 'blob:', 'data:', 'https://*.tile.openstreetmap.org', 'https://tile.openstreetmap.org', 'http:', 'https:'],
        'font-src': ['self', 'data:'],
        'connect-src': ['self', 'https://nominatim.openstreetmap.org', 'https://api.open-meteo.com', 'http:', 'https:', 'ws:', 'wss:'],
